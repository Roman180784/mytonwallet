(() => {
  ...
  function applyFriendlyPatch(container) {
    ...
    if (isDesktop) {
      ...
      mtwBtn.style.color = isDarkTheme ? '#FFFFFF' : '#0F0F0F';
      mtwBtn.style.backgroundColor = isDarkTheme ? '#1C1E24' : '#EDEFF4';
      mtwBtn.style.justifyContent = 'center';
      mtwBtn.style.fontWeight = '600';
      mtwBtn.style.fontSize = '16px';
      ...
      subtitleEl.innerHTML = subtitleEl.innerHTML.replace('Wallet in Telegram', '<b>MyTonWallet</b>');
